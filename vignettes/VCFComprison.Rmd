...
The *bins* notes the chromosome number, start position and end position of every bin (or window). Then, we can align the translocation table to the bin reference. Through function `Align_to_Bins`
